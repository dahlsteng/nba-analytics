"""
NBA Player Scoring Volatility Analysis — Historical (1979–2026)
===============================================================
Analyzes player scoring consistency/volatility from the 3-point era
through present day using Coefficient of Variation (CV = StdDev / PPG).

Filters: Min 15 minutes per game, min 20 games played.
...
Date range: Oct 12, 1979 – Mar 18, 2026
...
OUTPUT_DIR = os.path.join(SCRIPT_DIR, 'output_historical')

START_DATE  = '1979-10-12'
END_DATE    = '2026-03-18'
MIN_GAMES   = 20          # Minimum games to include a player (filters noise)
MIN_MINUTES = 15          # Exclude games where player logged < 15 minutes
...
<header>
  ...
  <p>How predictable are NBA scorers game-to-game? This dashboard covers the entire 3-point era (1979&ndash;present), filtering to games with 15+ minutes played. Volatility is measured using Coefficient of Variation (CV)&thinsp;&mdash;&thinsp;the ratio of standard deviation to mean scoring. Lower CV means more consistent output.</p>
  <div class="meta">Oct 12 1979 &ndash; Mar 18 2026 &nbsp;&middot;&nbsp; Regular Season &amp; Playoffs &nbsp;&middot;&nbsp; Min 15 min played &nbsp;&middot;&nbsp; Min {MIN_GAMES} games</div>
</header>
